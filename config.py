...
FARM_STEPS = [
    {
        "label": "Station",
        "files": ['station/station1.png', 'station/station2.png','station/station3.png', 'station/station4.png', 'station/station5.png', 'station/station6.png'],
        "thresh": 0.30, 
        "post_delay": 2.5  # ปรับเพิ่มจาก 2.48s ตามสถิติ 55 รอบ (avg: 2.25s, optimized: 2.48s) เพื่อให้หน้าจอเมนูหลักนิ่งสนิท
    },
    {
        "label": "Hero Battle",
        "files": ['hero_battle/HeroBattle.png'],
    ...
    {
        "label": "Start Match",
        "files": ['start_match/StartMatch.png', 'start_match/StartMatch2.png', 'start_match/StartMatch3.png'],
    ...
    {
        "label": "Next 1",
        "files": ['next/next.png', 'next/next2.png', 'next/next3.png', 'next/next4.png', 'next/next5.png', 'next/next6.png'],
        "thresh": 0.25, 
...
STATS_DIR = os.path.join(BASE_DIR, "stats")  # โฟลเดอร์เก็บ stats ทีละ 1 ชั่วโมง
STATS_FILE = os.path.join(BASE_DIR, "bot_stats.json")  # ไฟล์ stats ปัจจุบัน
...
MAX_WAIT_TIME_MATCH_PHASE = 120.0  # เวลาสูงสุดสำหรับ step ช่วงแข่ง คือ 120 วินาที
MATCH_PHASE_WAIT_COUNT = 120  # จำนวนครั้งที่รอก่อนเช็ครูปในช่วงแข่ง
MATCH_PHASE_WAIT_TIME = 1.0  # เวลารอแต่ละครั้งในช่วงแข่ง (วินาที)
